...
use crate::{Escrow, CANCEL_DELAY_SECONDS, error::ErrorCode};
...
pub fn handler(ctx: Context<Cancel>) -> Result<()> {
    ...
    let unlock_at = ctx.accounts.escrow.created_at.checked_add(CANCEL_DELAY_SECONDS).ok_or(ErrorCode::TimeLockActive)?;
